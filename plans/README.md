...
| 030 | X native playback verification + source health: HLS watchability probe after publish, retire/replace sources X cannot transcode, full X lifecycle in session logs (2026-07-08 spinner incident: pipeline fine, API-created source pb3w never transcoded) | P0 | M-L | 028, 029 | TODO (2026-07-08; incident root-caused via signed X API reads; slices ready) |
