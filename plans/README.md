...
- 2026-07-08: Plan 019 Step 3 started with Windows ffmpeg input builders,
  selected-source ID parsing, DXGI display discovery, and recording
...
| 019  | Finish Windows v1 capture and package acceptance                                                                                                                    | P2       | L      | 001, 002, 003, 006, 012                        | IN PROGRESS (2026-07-08; Windows input-builder, selected-source, and DXGI display-discovery seams started; real Windows package/capture/signing evidence pending)                   |
...
- **P7-S3 Windows capture MVP - IN PROGRESS**: Plan 019 Step 3. Windows ffmpeg
  input builders, selected-source ID parsing, DXGI display discovery, and
  recording primary-input tests now cover display, camera, and mic variants;
  native camera/mic discovery, preview capture pipelines, and on-box recording
